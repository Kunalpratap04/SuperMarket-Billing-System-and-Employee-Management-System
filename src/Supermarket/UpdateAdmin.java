    ...
    private void updateMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_updateMouseClicked
        ...
        else
        {
            try
            {
                ...
                String query="Update Manager.ADMIN set ADMINNAME='"+name.getText()+"' "+" ,ADMINPASS ='"+pass.getText()+"'"+" where ID="+1;
                Statement add=con.createStatement();
                add.executeUpdate(query);
                JOptionPane.showMessageDialog(this, "Passsword updated Successfully");
